        ...
        function generateReport($class, $term, $ice, $conn) {
            ...
            if($term === "term 1"){
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    $sel = "SELECT SUM(cat11+ex1) as toto , SUM(cat11) as tot FROM assessments WHERE classid=(SELECT id FROM class WHERE class='$class')";
                    $resul = mysqli_fetch_assoc(mysqli_query($conn , $sel))['toto'];
                    $resul1 = mysqli_fetch_assoc(mysqli_query($conn , $sel))['tot'];

                    $this->Cell(15, 6, $resul1, 1, 0, 'C');
                    $this->Cell(15, 6, $resul1, 1, 0, 'C');
                    $this->Cell(15, 6, $resul, 1, 0, 'C');
                    ...
                    if(($step111/$resul)<5){
                        ...
                        $this->SetTextColor('0','0','0');
                        $this->Cell(94, 8, round((($step111/$max)*100),1).' /100', 1, 0, 'C');
                    }
                    ...
                    $this->cell(93, 10, round($term1,0), 1, 0, 'C');
                    $this->Ln();
                    $this->setY(-80);
                    $this->setX(15);
